...
module.exports = {
  apps: [
    ...
    // },
    {
      ...
      watch: false, // files change automatic restart
      ignore_watch: ["node_modules", "logs"], // ignore files change
      max_memory_restart: "8G", // restart if process use more than 1G memory
      merge_logs: true, // if true, stdout and stderr will be merged and sent to pm2 log
      output: "./logs/stage/access.log", // pm2 log file
      error: "./logs/stage/error.log", // pm2 error log file
      env: {
        // environment variable
        PORT: 3001,
        PORT_HTTP: 3000,
    ...
    },
    {
      ...
      max_memory_restart: "8G", // restart if process use more than 1G memory
      merge_logs: true, // if true, stdout and stderr will be merged and sent to pm2 log
      output: "./logs/dev/access.log", // pm2 log file
      error: "./logs/dev/error.log", // pm2 error log file
      env: {
        // environment variable
        PORT: 3001,
        PORT_HTTP: 3000,
